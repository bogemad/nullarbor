...
This is a direct fork from the excellent Nullarbor pipeline written by Torsten Seemann, who deserves all credit for this work. It is a quick and dirty modification to enable use with single-end sequencing reads generated by Ion Torrent instruments. Please see https://github.com/tseemann/nullarbor if you want to use this with Illumina paired-end sequencing reads. The documentation below is modified from Torsten's original documentation.
